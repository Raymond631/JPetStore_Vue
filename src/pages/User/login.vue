                    ...
                    <div class="loginbox">
                        <div class="btn login_area">
                            <div autocomplete="off" method="post">
                                <input class="item_account" id="username" v-model="username" name="userId"
                                       placeholder="账号"
                                       type="text">
                                <input class="item_account" id="pwd" v-model="password" name="password"
                                       placeholder="密码"
                                       type="password">
                                <input class="code_input" id="code" v-model="verificationCode" name="vCode"
                                       placeholder="验证码"
                                       type="text">
                                <a class="code_link">
