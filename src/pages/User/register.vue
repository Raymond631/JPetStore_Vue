                    ...
                    <div class="loginbox">
                        <div class="btn login_area">
                            <div action="/jpetstore/User/register" autocomplete="off" id="registerForm" method="post">
                                <input class="item_account" v-model="username" id="username" name="userId"
                                       placeholder="账号"
                                       type="text">
                                <div class="err_tip" id="name_repeat"></div>
                                <input class="item_account" v-model="password" id="pwd" name="password"
                                       placeholder="密码"
                                       type="password">
                                <input class="item_account" v-model="comfirmPassword" id="password_repeat"
                                       name="password_repeat"
                                       placeholder="确认密码"
                                       type="password">
                                <input class="code_input" v-model="verificationCode" id="code" name="vCode"
                                       placeholder="验证码"
                                       type="text">
                                <a class="code_link">
