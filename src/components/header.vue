        ...
        <div class="site-header">
            <div class="container myclear">
                ...
                <div class="myclear header-search">
                    <div>
                        <input v-model="searchContent" class="search-text" id="search" name="keyword"
                               style="border-color: #ff6700"
                               type="text" @input="getTips"/>
                        <input class="search-btn" id="search_btn" style="border-color: #ff6700" type="submit"
                               @click="search"
                               value=" "/>
                    </div>
